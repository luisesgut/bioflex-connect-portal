...
const translations: Record<Language, Record<string, string>> = {
  en: {
   ...
   'nav.destinyPlan': 'Destiny Plan',
    ...
    'productRequests.viewEngineeringShort': 'Eng',
    'productRequests.viewDesignShort': 'Des',
    'productRequests.workQueue': 'Work Queue',
  ...
  es: {
   ...
   'nav.destinyPlan': 'Plan Destiny',
    ...
    'productRequests.viewEngineeringShort': 'Ing',
    'productRequests.viewDesignShort': 'Dis',
    'productRequests.workQueue': 'Cola de Trabajo',
